...
const offcanvas = document.getElementById('offcanvas-collapse');
...
function toggleCanvas() {
    offcanvas?.classList.contains('open') ? offcanvas.classList.remove('open') : offcanvas.classList.add('open')
}
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const offcanvasButton = document.getElementById('offcanvasDarkNavbar');
    const offcanvasClose = document.getElementById('offcanvas-close');

    // Offcanvas toggle on click and load leaderboard on open
